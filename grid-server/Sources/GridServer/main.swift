...
struct GridServerCommand: ParsableCommand {
    ...
    func run() throws {
        ...
        do {
            ...
            PickerManager.shared.configure(with: gridConfig, windowManipulator: windowManipulator, gridReconciler: gridReconciler, gridState: gridState, stateManager: StateManager.shared)
