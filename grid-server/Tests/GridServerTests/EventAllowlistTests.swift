...
final class EventAllowlistTests: XCTestCase {
    ...
    private let allowlist: Set<String> = [
        ...
        "layout.apply.done", "layout.apply.start", "layout.cell.start",
        ...
        "reconcile.init", "reconcile.pending.expired", "reconcile.pending.set",
        "reconcile.pending.space.mismatch", "reconcile.space.change",
        "reconcile.wake.done", "reconcile.wake.migrated", "reconcile.wake.start",
        ...
        "state.shutdown.done", "state.shutdown.start", "state.space_migrated",
        "sweep.correct", "sweep.timer.start",
        ...
        "validate.end", "validate.init", "validate.space.prune",
